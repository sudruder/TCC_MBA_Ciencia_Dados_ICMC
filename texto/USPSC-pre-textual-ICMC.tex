...
\titulo{Análise dos Fatores Socioeconômicos no Desempenho do ENEM: Uma Abordagem com \textit{Machine Learning}} 
\titleabstract{Analysis of Socioeconomic Factors on ENEM Performance: A Machine Learning Approach}
\tituloadic{Analysis of Socioeconomic Factors on ENEM Performance: A Machine Learning Approach}
\tituloresumo{Análise dos Fatores Socioeconômicos no Desempenho do ENEM: Uma Abordagem com \textit{Machine Learning}}
...
\autor{Ramon de Castro Ramos}
\autorficha{RAMOS, Ramon de Castro}
\autorabr{RAMOS, R. C.}
...
\orientadoradic{Advisor: Prof. Dr. Adriano Kamimura Suzuki}
\orientadorcorpoficha{orientador Prof. Dr. Adriano Kamimura Suzuki}
