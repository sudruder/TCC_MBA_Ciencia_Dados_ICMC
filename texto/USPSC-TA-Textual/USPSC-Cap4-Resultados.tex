...
% 7      ano_conclusao_ensino_medio  51.603048
...
% 13                03_ocupacao_pai  12.518470
% 14            01_escolaridade_pai   9.838316
% 15                04_ocupacao_mae   8.991262
...
% 23               08_qtde_banheiro   0.578713
% 24                 09_qtde_quarto   0.578713
% 25           18_flag_aspirador_po   0.578713
...
% 37           24_qtde_computadores   0.578713
...
Foi decidido manter todas as edições do ENEM no conjunto de dados para a modelagem preditiva, sem a necessidade de segmentação por edição, uma vez que o tamanho do efeito é insignificante ou pequeno.
...
\subsubsection{Análise de Outliers}\label{resultados_analise_exploratoria_dados_vars_preditoras_outliers}

\subsubsection{Distribuições}\label{resultados_analise_exploratoria_dados_vars_preditoras_distribuicoes}

\subsubsection{Teste de Hipótese}\label{resultados_analise_exploratoria_dados_vars_preditoras_teste_hipotese}
