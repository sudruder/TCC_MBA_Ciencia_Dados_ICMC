...
Para as demais variáveis com valores nulos, foi realizada uma análise consolidade, ou seja, foram retiradas as observações que possuíam valor nulo em qualquer uma das variáveis restantes, o que resultou na retirada de 4.343.559 observações do conjunto de dados.
...
Essa diferença na granularidade das notas impacta diretamente na escolha dos modelos preditivos e nas métricas de avaliação, conforme será discutido na Seção \ref{resultados_escolha_modelos}.
...
\begin{longtable}{|l|c|c|c|c|c|}
    ...
    Média & 523,8 & 496,9 & 519 & 538,7 & 616,6 \\ \hline
