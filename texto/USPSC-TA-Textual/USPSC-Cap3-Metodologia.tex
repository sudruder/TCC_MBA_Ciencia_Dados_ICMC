...
A análise exploratória foi iniciada com o entendimento do domínio das variáveis respostas, buscando entender a distribuição das notas do ENEM e identificar possíveis padrões ou anomalias nos dados.
